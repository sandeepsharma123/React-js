        ...
        <div>
            ...
            <div class="container-fluid facts my-5 py-5">
                <div class="container py-5">
                    * <div class="row g-5">
                        <Factcounter icon="fa fa-users fa-3x text-white mb-3" name="Happy Clients" />
                        <Factcounter icon="fa fa-check fa-3x text-white mb-3" name="Projects Completed" />
                        <Factcounter icon="fa fa-users-cog fa-3x text-white mb-3" name="Dedicated Staff" />
                        <Factcounter icon="fa fa-award fa-3x text-white mb-3" name="Awards Achieved" />
                    </div>
                    {/* <div class="row g-5">
            ...
            <div class="container-xxl py-5">
                <div class="container">
                    ...
                    <div class="row g-4">
                        <Teamcard name="Kate Winslet" img="img/team-1.jpg" />
                        <Teamcard name="Jac Josan" img="img/team-2.jpg" />
                        <Teamcard name="Doris Jordan" img="img/team-3.jpg" />
